...
from onyx.background.celery.tasks.shared.tasks import LIGHT_SOFT_TIME_LIMIT, LIGHT_TIME_LIMIT
from onyx.configs.app_configs import JOB_TIMEOUT
from onyx.configs.constants import CELERY_VESPA_SYNC_BEAT_LOCK_TIMEOUT, OnyxCeleryQueues, OnyxCeleryTask, OnyxRedisLocks
from onyx.db.connector import fetch_connector_by_id, mark_cc_pair_as_permissions_synced, mark_ccpair_as_pruned
from onyx.db.connector_credential_pair import add_deletion_failure_message, delete_connector_credential_pair__no_commit, get_connector_credential_pair_from_id, get_connector_credential_pairs
from onyx.db.document import count_documents_by_needs_sync, get_document, get_document_ids_for_connector_credential_pair, mark_document_as_synced
from onyx.db.document_set import delete_document_set, delete_document_set_cc_pair_relationship__no_commit, fetch_document_sets, fetch_document_sets_for_document, get_document_set_by_id, mark_document_set_as_synced
from onyx.db.engine import get_session_with_tenant
from onyx.db.enums import IndexingStatus
from onyx.db.index_attempt import delete_index_attempts, get_index_attempt, mark_attempt_failed
...
from onyx.redis.redis_connector_doc_perm_sync import RedisConnectorPermissionSync, RedisConnectorPermissionSyncPayload
...
from onyx.utils.variable_functionality import fetch_versioned_implementation, fetch_versioned_implementation_with_fallback, global_version, noop_fallback
