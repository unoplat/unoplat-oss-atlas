...
# First Party
from onyx.configs.app_configs import INDEX_BATCH_SIZE, MAX_FILE_SIZE_BYTES
from onyx.configs.constants import DocumentSource
from onyx.connectors.google_drive.doc_conversion import build_slim_document, convert_drive_item_to_document
from onyx.connectors.google_drive.file_retrieval import crawl_folders_for_files, get_all_files_for_oauth, get_all_files_in_my_drive, get_files_in_shared_drive
from onyx.connectors.google_drive.models import GoogleDriveFileType
from onyx.connectors.google_utils.google_auth import get_google_creds
from onyx.connectors.google_utils.google_utils import execute_paginated_retrieval
from onyx.connectors.google_utils.resources import get_admin_service, get_drive_service, get_google_docs_service
from onyx.connectors.google_utils.shared_constants import DB_CREDENTIALS_PRIMARY_ADMIN_KEY, MISSING_SCOPES_ERROR_STR, ONYX_SCOPE_INSTRUCTIONS, SCOPE_DOC_URL, SLIM_BATCH_SIZE, USER_FIELDS
