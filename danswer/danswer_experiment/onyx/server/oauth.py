...
# First Party
from ee.onyx.configs.app_configs import OAUTH_CONFLUENCE_CLIENT_ID, OAUTH_CONFLUENCE_CLIENT_SECRET, OAUTH_GOOGLE_DRIVE_CLIENT_ID, OAUTH_GOOGLE_DRIVE_CLIENT_SECRET, OAUTH_SLACK_CLIENT_ID, OAUTH_SLACK_CLIENT_SECRET
from onyx.auth.users import current_user
from onyx.configs.app_configs import WEB_DOMAIN
from onyx.configs.constants import DocumentSource
from onyx.connectors.google_utils.google_auth import get_google_oauth_creds, sanitize_oauth_credentials
from onyx.connectors.google_utils.shared_constants import DB_CREDENTIALS_AUTHENTICATION_METHOD, DB_CREDENTIALS_DICT_TOKEN_KEY, DB_CREDENTIALS_PRIMARY_ADMIN_KEY, GoogleOAuthAuthenticationMethod
